...
interface Tag { id: string; name: string; description: string | null; course_type: string | null; faculty_names: string | null; aliases: string[] | null; display_order: number; is_active: boolean; }
